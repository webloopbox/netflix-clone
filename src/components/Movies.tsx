...
export const Movies = () => {
    ...
    const { topMoviesReady } = useSelector((state: RootState) => state.ui)
        ...
        <main className="movies-wrapper">
            <section className="top-movies-actual">
                ...
                <div className="slider">
                    ...
                    >
                        {
                            topMoviesReady && topMovies.map((movie: any, index) => {
            ...
            <img src="https://www.themoviedb.org/assets/2/v4/logos/v2/blue_square_1-5bdc75aaebeb75dc7ae79426ddd9be3b2be1e342510f8202baf6bffa71d7f5c4.svg" alt="TMDB attribution" />
